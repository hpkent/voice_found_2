class GroupsController < ApplicationController
  ...
  def all_clients_in_group
    ...
    @clients = Client.active_client.order(:category_type_id)
  end

  def update_clients_in_group
    @clients_group = ClientsGroup.where(group_id:params[:clients_group][:group_id],client_id:params[:clients_group][:client_id]).first_or_initialize
  ...
  def delete_clients_groups
    clients_groups = ClientsGroup.find(params[:clients_groups_id])
